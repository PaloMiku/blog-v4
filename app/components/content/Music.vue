...
const titleText = computed(() => {
	...
	if (meta.value.id)
		return `${meta.value.provider} 音乐 - ${meta.value.id}`
...
>
	...
	<span class="music-embed-single-line">{{ titleText }}，{{ subtitleText }}</span>
</a>
<div v-else class="music-embed-empty">
	无效音乐链接
</div>
</template>
